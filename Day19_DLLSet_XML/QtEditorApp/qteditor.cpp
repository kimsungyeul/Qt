    ...
    : QMainWindow(parent)
{
    ...
    //QAction* pasteAct = makeAction(":/images/paste.png",tr("&Paste"),tr("Ctrl+Shift+V"),tr("Save as this program"), this,SLOT(()));
